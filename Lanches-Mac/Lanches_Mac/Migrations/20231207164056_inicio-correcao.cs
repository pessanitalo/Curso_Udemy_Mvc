...
{
    /// <inheritdoc />
    public partial class iniciocorrecao : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Endereco1 = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ...
                    PedidoEntregue = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarrinhoId = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrinhoItens", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarrinhoItens_Lanches_LancheId",
                        column: x => x.LancheId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrinhoItens_LancheId",
                table: "CarrinhoItens",
                column: "LancheId");
